...
// DistinctTemplateTags returns the sorted distinct individual tags across all
// session-template labels (which are comma-separated).
...
func distinctTagsFromLabels(labels []string) []string {
...
//
// "5" and "5+" sit below "5a" and are kept for climbs already logged on them. They are
// not real French grades — a 5+ is around a 5c in practice — so they rank low rather
// than in their true place. Removing them would drop those climbs out of hardest-sent
// and the grade pyramid, which is worse than an imprecise rank on a grade nobody
// climbs at any more.
func buildGradeRanks() map[string]int {
	lists := [][]string{
		{"3", "3+", "4", "4+", "5", "5+", "5a", "5b", "5c", "6a", "6a+", "6b", "6b+", "6c", "6c+", "7a", "7a+", "7b", "7b+", "7c", "7c+", "8a", "8a+", "8b", "8b+", "8c", "8c+", "9a"},
		{"3", "3+", "4", "4+", "5", "5+", "5a", "5b", "5c", "6a", "6a+", "6b", "6b+", "6c", "6c+", "7a", "7a+", "7b", "7b+", "7c", "7c+", "8a", "8a+", "8b", "8b+", "8c", "8c+", "9a", "9a+", "9b", "9b+", "9c"},
